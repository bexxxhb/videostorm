...
class SlugTest {
    ...
    void joinsNormalisedTitleAndYearWithHyphens() {
        assertThat(Slug.of("96 Hours - Taken 3", 2014)).isEqualTo("96-hours-taken-3-2014");
    }

    @Test
    void stripsAccentsAndCaseSoRemakesShareShapeButDifferInYear() {
        assertThat(Slug.of("Mädchen", 1990)).isEqualTo("madchen-1990");
        assertThat(Slug.of("The Thing", 1982)).isEqualTo("the-thing-1982");
        assertThat(Slug.of("The Thing", 2011)).isEqualTo("the-thing-2011");
    }

    @Test
    void marksAMissingYearWithZeroRatherThanDroppingIt() {
        assertThat(Slug.of("Untitled", 0)).isEqualTo("untitled-0");
    }
}
