...
class StagedMovieTest {
    ...
    void computesNormalisationSlugAndGenreStorage() {
        ...
        assertThat(staged.sizeBytes()).isEqualTo(1_500_000_000L);
        assertThat(staged.rawNfo()).isEqualTo("<movie/>");
    }

    @Test
    void foldsAMissingYearToZeroAndAnEmptyGenreListToNoColumn() {
        StagedMovie staged = StagedMovie.from(parsed(null, List.of(), List.of()), "Taken 3", "/p", 0L, "x", null);
    ...
    void fallsBackToTheFolderNameAndFlagsADerivedTitleWhenMetadataHasNone() {
        ...
        StagedMovie staged = StagedMovie.from(noTitle, "The Blob (1958).mkv", "/p", 0L, "x", null);
    ...
    void derivesTheIdentityTitleFromTheOriginalTitleWherePresent() {
        StagedMovie staged = StagedMovie.from(parsed(2014, List.of(), List.of()), "Taken 3", "/p", 0L, "x", null);
    ...
    void fallsBackToTheDisplayTitleForIdentityWhenNoOriginalTitle() {
        ...
        StagedMovie staged = StagedMovie.from(noOriginal, "The Thing (1982)", "/p", 0L, "x", null);
    ...
    void identityTitleFallsThroughToTheFolderDerivedTitleWhenNothingWasParsed() {
        ...
        StagedMovie staged = StagedMovie.from(nothing, "The Blob (1958).mkv", "/p", 0L, "x", null);
    ...
    void picksTheProviderEmbyFlaggedDefaultForTheInlineColumns() {
        ...
        StagedMovie staged = StagedMovie.from(parsed(2014, List.of(imdb, tmdb), List.of()), "Taken 3", "/p", 0L, "x", null);
    ...
    void fallsBackToTheFirstRatingWhenNoneIsFlaggedDefault() {
        ...
        StagedMovie staged = StagedMovie.from(parsed(2014, List.of(first, second), List.of()), "Taken 3", "/p", 0L, "x", null);
    ...
    void carriesTheParsedCastThroughInBillingOrder() {
        ...
        StagedMovie staged = StagedMovie.from(parsed, "Taken 3", "/p", 0L, "x", null);
