...
/**
 * The run view exposes the tally as display-ready fields, including the skipped count the run history
 * column reads.
 */
class IndexingRunViewTest {
    ...
    @Test
    void exposesFoundIndexedAndSkippedFromTheRunCounts() {
        IndexingRun run = new IndexingRun(1L, SourceType.MOVIES, RunStatus.COMPLETED,
                T0, T0.plusSeconds(60), new RunCounts(9, 7, 2));
